...
public class NextWarmerDay: ITestable
{
    ...
    void ITestable.RunTests()
    {
        ...
        var cases = new[]
        {
            (Arr(73,74,75,71,69,72,76,73), Arr(1,1,4,2,1,1,0,0)),
            (Arr(30,40,50,60), Arr(1,1,1,0)),
            (Arr(30,60,90), Arr(1,1,0)),
            (Arr(55,38,53,81,61,93,97,32,43,78), Arr(3,1,1,2,1,1,0,1,1,0)),
        };
